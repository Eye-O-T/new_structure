# RTSP v1.0 레거시 실행 가이드

## 목차

- [1. 패키지 목록 업데이트](#1-패키지-목록-업데이트)
- [2. GStreamer 핵심 라이브러리 및 카메라 유틸리티 설치](#2-gstreamer-핵심-라이브러리-및-카메라-유틸리티-설치)
- [3. RTSP 송출/백업/API 통합 실행](#3-rtsp-송출백업api-통합-실행)
- [로그 파일](#로그-파일)
